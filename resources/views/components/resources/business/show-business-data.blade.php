...
<x-table.element.tr>
    ...
    <x-table.element.td>
        <img src="{{ $data2->getMedia('logo')->last()?->getUrl() }}" alt="" width="64px">
    </x-table.element.td>
</x-table.element.tr>
<x-table.element.tr>
    <x-table.element.th data="Authorised Signature" />
    <x-table.element.td>
        <img src="{{ $data2->getMedia('authorised_sign')->last()?->getUrl() }}" alt="" width="64px">
    </x-table.element.td>
</x-table.element.tr>
<x-table.element.tr>
    <x-table.element.th data="Authorised Stamp" />
    <x-table.element.td>
        <img src="{{ $data2->getMedia('authorised_stamp')->last()?->getUrl() }}" alt="" width="64px">
    </x-table.element.td>
</x-table.element.tr>
<x-table.element.tr>
...
<x-table.element.tr>
    ...
    <x-table.element.td>
        <a href="{{ $data2->getMedia('registration_certificate')->last()?->getUrl() }}" target="_blank">View</a>
    </x-table.element.td>
</x-table.element.tr>
<x-table.element.tr>
...
<x-table.element.tr>
    ...
    <x-table.element.td>
        <a href="{{ $data2->getMedia('gst_certificate')->last()?->getUrl() }}" target="_blank">View certificate</a>
    </x-table.element.td>
</x-table.element.tr>
<x-table.element.tr>

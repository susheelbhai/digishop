<x-layout.admin.app>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <x-form.type.standard title="Create Business" action="{{ route('admin.business_application.store') }}">
                <x-form.element.form-group title="Business Detail">
                    ...
                    <x-form.element.input1 name="state_id" label="State" type="select" :options="$states" value="10" required="required" />
                    ...
                    <x-form.element.input1 name="authorised_sign" label="Authorised Sign" type="file" />
                    <x-form.element.input1 name="authorised_stamp" label="Authorised Stamp" type="file" />

<x-layout.admin.app>
    ...
    <x-form.type.standard title="Edit Profile" action="{{ route('admin.profile.update', $user->id) }}" div=1>
        @method('patch')
            ...
            <x-form.element.input-img name="profile_pic" :value="asset('images/profile_pic/admin/'.$user['profile_pic'])" label="Profile Pic" type="image" div="4" ratio="125" />

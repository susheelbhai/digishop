...
<section class="border bg-[#F8F9FE]">
    <div class="mx-auto flex max-w-7xl py-16">
        <div class="grid grid-cols-2">
            <div class="pr-8">
                <h5 class="text-primary">EMPOWERMENT</h5>
                <h1 class="font-medium text-6xl">Seamless exprience for all your stock management and invoice needs.</h1>
                <p class="my-5">Keep track of all your business data like orders, invoice, payments, employess and more. Get all the data at your fingertips.</p>
                <div class="btns-group d-flex">
                    <a href="#">
                        <x-ui.button.small> Learn More </x-ui.button.small>
                    </a>
                    <a href="#">
                        <x-ui.button.small> Let's Talk <i class="iconoir-arrow-up-right"></i> </x-ui.button.small>
                    </a>
                </div>
            </div>

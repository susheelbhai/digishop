...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://digamite.com/storage/themes/user/images/logo/favicon.ico" />
    <style>
        @page {
            margin: 0;
            size: A4;
                    ...
                    <tr style="border: solid">
                        ...
                        <td style="border: solid">
                            ...
                            <div class="authorised_sign">
                                @if ($data['invoiceSetting']['authorised_sign'] == 1 )
                                <img src="{{ $data->getLastMediaBase64('authorised_sign') }}" width="126px"
                                    style="margin-top: 0">
                                @endif
                                @if ($data['invoiceSetting']['authorised_stamp'] == 1 )
                                <img src="{{ $data->getLastMediaBase64('authorised_stamp') }}" width="126px"
                                    style="margin-top: 0">
                                @endif

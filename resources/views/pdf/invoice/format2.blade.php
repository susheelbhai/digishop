                    ...
                    <tbody>
                        @foreach ($data['products'] as $i)
                            @php
                                ...
                                $i['taxable_amount'] = $i['sale_price'] / (1+.01*$i['gst_percentage']);
                                $i['gst_amount'] = $i['sale_price'] - $i['taxable_amount'];
                            @endphp
                            <tr>
                                <td style="width:50%;">
                                    <h5>{{ $i['name'] }}</h5>
                                ...
                                @if ($data['business_state_id'] == $data['customer_state_id'])
                                    <td class="amount">
                                        ...
                                        <br>
                                        {{ App\Helpers\Helper::customMoneyFormat($i['gst_amount'] * $i['quantity'] /2) }}
                                    </td>
                                    <td class="amount">
                                        {{ $i['gst_percentage'] * 0.5 }}%
                                        <br>
                                ...
                                @else
                                    <td class="amount" colspan="1">
                                        {{ $i['gst_percentage'] }}%
                                        <br>
                                        {{ App\Helpers\Helper::customMoneyFormat($i['gst_amount'] * $i['quantity']) }}
                                    </td>
                                @endif
                                <td>
